...
public class LoggerTest {
    ...
    public void testLogger() {
        Logger lg = Logger.create("C:\\Users\\windows\\Desktop\\logger_test");
        lg.log("aaa".getBytes());
        lg.log("bbb".getBytes());
        lg.log("ccc".getBytes());
        lg.log("ddd".getBytes());
        ...
        lg = Logger.open("C:\\Users\\windows\\Desktop\\logger_test");
        lg.rewind();
        ...
        assert new File("C:\\Users\\windows\\Desktop\\logger_test.log").delete();
    }
}
