package top.wuzonghui.simpledb.backend.parser;
...
public class ParserTest {
    ...
    public void testRead() throws Exception {
        String stat = "select name, id, strudeng from student";
//        String stat = "select name, id, strudeng from student where id > 1 and id < 4";
    ...
    public void testInsert() throws Exception {
        String stat = "insert into student values 5 \"wzh\" 22";
        Object res = Parser.Parse(stat.getBytes());
...
//        String stat = "delete from student where name = \"wzh\"";
        String stat = "delete from student";
        Object res = Parser.Parse(stat.getBytes());
    ...
    public void testUpdate() throws Exception {
        String stat = "update student set name = \"wzh\" where id = 5";
        Object res = Parser.Parse(stat.getBytes());
